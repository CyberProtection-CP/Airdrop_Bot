...
CHANNELS = [
    "-1002476961589",  # Technical_Monster_Official
    "-1002271283410"   # onlineincome_max
]
...
async def send_airdrop_intro(update: Update, context: ContextTypes.DEFAULT_TYPE):
    caption = (
        ...
        "👉 নিচের চ্যানেলগুলোতে যোগ দিন:\n\n"
        "📢 @Technical_Monster_Official\n"
        "📢 @onlineincome_max\n\n"
        "✅ চ্যানেলগুলোতে যোগ দিয়ে নিচের বাটনে ক্লিক করুন।"
    )
    keyboard = InlineKeyboardMarkup([
        [InlineKeyboardButton("📢 Technical_Monster_Official", url="https://t.me/Technical_Monster_Official")],
        [InlineKeyboardButton("📢 onlineincome_max", url="https://t.me/onlineincome_max")],
